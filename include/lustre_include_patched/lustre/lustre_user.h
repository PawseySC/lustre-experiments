...
{
	enum changelog_rec_flags crf = (changelog_rec_flags) ((int) rec->cr_flags & CLF_VERSION);
...
{
	enum changelog_rec_flags crf = (changelog_rec_flags) ((int) rec->cr_flags &
...
{
	return (char *)rec + changelog_rec_offset((changelog_rec_flags) ((int)rec->cr_flags &
						  CLF_SUPPORTED));
}
				       ...
				       enum changelog_rec_flags crf_wanted)
{
	...
	crf_wanted = (changelog_rec_flags) ((int) crf_wanted & CLF_SUPPORTED);
	...
	jid_mov = (char *)rec +
		  changelog_rec_offset((changelog_rec_flags)((int) crf_wanted & ~CLF_JOBID));
	rnm_mov = (char *)rec +
		  changelog_rec_offset((changelog_rec_flags)((int)crf_wanted & ~(CLF_JOBID | CLF_RENAME)));
